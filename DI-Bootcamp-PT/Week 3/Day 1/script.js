...
// Étape 1: Stockez votre année de naissance dans une variable.
// let anneeDeNaissance = 1990;

// Étape 2: Stockez une année future dans une variable.
// let anneeFuture = 2023;

// Étape 3: Calculez vos âges possibles pour cette année en fonction des valeurs stockées.
// let ageActuel = anneeFuture - anneeDeNaissance;
// let ageFutur = ageActuel + 1; // Âge que vous aurez l'année suivante

// Étape 4: Afficher : "Je serai NN en AAAA", en remplaçant les valeurs.
// console.log("Je serai " + ageActuel + " en " + anneeFuture);
// console.log("Je serai " + ageFutur + " en " + (anneeFuture + 1));
...
// exercice 3
// Étape 1: Créez une table indexée numériquement (tableau) : pets
// let pets = ["chat", "chien", "poisson", "lapin", "vache"];

// Étape 2: Afficher 'chien'
// console.log(pets[1]); // Affiche 'chien'

// Étape 3: Ajoutez au tableau pets l'animal de compagnie 'cheval'. Supprimez l'animal 'lapin'.
// pets.push('cheval'); // Ajoute 'cheval' à la fin du tableau
// pets.splice(4,1);

// Étape 4: Afficher la longueur du tableau
// console.log(pets.length); // Affiche la longueur actuelle du tableau
